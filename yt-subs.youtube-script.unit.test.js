...
describe('youtubeScript', () => {
    ...
    it('defaults to plain text output when no textType option is set', async () => {
        ...
        const deps = {
            ...
            toPlainText: () => { plainTextCalled = true; return fakeTranscriptText; },
    ...
    it('with textType srt, uses toSRT instead of toPlainText', async () => {
        ...
        const deps = {
            ...fakeDepsBase,
            fetchTranscript: async () => ({ videoDetails: fakeVideoDetails, segments: fakeSegments }),
            toPlainText: () => { throw new Error('toPlainText should not be called'); },
    ...
    it('with noCache: true, skips FsCache construction and passes cache: undefined', async () => {
        ...
        const deps = {
            FsCache: class { constructor() { fsCacheConstructed = true; } },
